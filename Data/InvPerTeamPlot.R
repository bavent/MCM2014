data <- read.csv(file="CBBM/Team Rank/InversionPerGamePlot.txt", head=FALSE, sep=",")
#data <- read.csv(file="CFB/Team Rank/BrendanSucksPlot.txt", head=FALSE, sep=",")
...
axis(2, las=1, at=c(0,5,10,15,20,25,30)/100)
...
title(xlab="Year")
title(ylab="Edge Inversions Per Game")

# Create a legend at (1, g_range[2]) that is slightly smaller 
# (cex) and uses the same line colors and points used by 
# the actual plots 
legend(1, 0.06, c("Stochastic Heuristic","PageRank","FAS Approximation", "Win/Loss"), cex=0.8, 
